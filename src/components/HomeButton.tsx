...
const HomeButton: React.FC<HomeButtonProps> = ({ titlePage }) => {
    ...
    return (
        <div className="w-full border lg:absolute h-fit flex items-center gap-3 lg:px-4 justify-start hover:border-gray-400 dark:hover:border-gray-600 transition-all duration-200">
            <button
                onClick={() => navigate(-1)}
