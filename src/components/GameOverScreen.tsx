...
const GameOverScreen: React.FC<GameOverScreenType> = ({
    ...
    return (
        <PopUp visible={true}>
            <div className='py-10 h-screen border dark:border-gray-700 border-neutral-300 dark:bg-retro-card/90 bg-blue-400/70 shadow-2xl w-screen flex flex-col items-center justify-center gap-4'>
                ...
                {isEmptyLives ? (
                    ...
                    <p className='shadow border w-full border-white/10 text-center py-2 px-2 dark:bg-neutral-600 bg-blue-300  text-xs lg:text-base text-retro-text  text-shadow-2xs'>You've run out of lives on <span className='dark:text-retro-purple text-retro-mint'>"{currentProvince.name}"</span>. Better luck next time!</p>
                ) : (
                    // <TypingText
                    //     isSubmitted={true}
                    ...
                    <p className='shadow border w-full border-white/10 text-center py-2 px-2 dark:bg-neutral-600 bg-blue-300  text-xs lg:text-base text-retro-text  text-shadow-2xs'>Congratulations! You’ve completed the challenge!</p>
                )}
