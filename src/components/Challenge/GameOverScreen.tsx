...
const GameOverScreen: React.FC<GameOverScreenType> = ({
    ...
    return (
        <PopUp visible={true}>
            <div className='py-10 h-screen dark:bg-retro-card bg-blue-400 shadow-2xl w-screen flex flex-col gap-4'>
                ...
                <GameOverMessage finish={isFinish} timeOut={timeOut} isEmptyLives={isEmptyLives} provinceName={currentProvince.name} />
                <div className="w-full relative dark:bg-neutral-600">
                    <div className="flex overflow-x-auto whitespace-nowrap justify-start px-2 md:justify-evenly xl:w-[75%] w-full mx-auto">
                        <GameStats title="Map Completed" value={completedCount} totalValue={totalCount} />
